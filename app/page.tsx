...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  upgradeOverlay: { position: "fixed" as const, inset: 0, background: "rgba(0,0,0,0.85)", backdropFilter: "blur(4px)", zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center", padding: "20px" }, { background: "#111827", border: "1px solid #334155", borderRadius: "16px", padding: "32px", maxWidth: "440px", width: "100%", boxShadow: "0 25px 60px rgba(0,0,0,0.5)", display: "flex", flexDirection: "column" as const, gap: "16px", position: "relative" as const, margin: "auto" },
